  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        short_name: "STELS",
        description:
          "Distributed Web OS for autonomous AI web agents. Professional laboratory for Web 5 developers built on heterogeneous networks.",
        theme_color: "#f59e0b",
        ...
        runtimeCaching: [
          ...
          },
          {
            ...
            urlPattern: ({ url }: { url: URL }) => {
              return url.pathname.startsWith("/schemas/") &&
