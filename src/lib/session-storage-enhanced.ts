...
class EnhancedSessionStorageManager {
  ...
  public static getInstance(): EnhancedSessionStorageManager {
    if (!EnhancedSessionStorageManager.instance) {
      EnhancedSessionStorageManager.instance =
        new EnhancedSessionStorageManager();
    }
  ...
  public async setItem(
    ...
    if (
      finalSize > SESSION_STORAGE_SIZE_LIMIT || this.wouldExceedLimit(finalSize)
    ) {
  ...
  private async saveToIndexedDB(
    ...
    try {
      ...
      console.error(
        "[EnhancedSessionStorage] Failed to save to IndexedDB:",
        error,
      );
      throw error;
    }
