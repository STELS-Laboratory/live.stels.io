...
export function TokenDetailModal({
  ...
  const marketCap = displayPrice !== null && initialSupplyNum > 0
    ...
    : null;
  const maxMarketCap =
    displayPrice !== null && maxSupplyNum !== null && maxSupplyNum > 0
                      ...
                      <CardContent>
                        <div className="flex items-center gap-2">
                          ...
                          <Button
                            ...
                            className="h-6 w-6 p-0"
                            onClick={() =>
                              copyToClipboard(economics.treasury || "")}
                          >
                            <Copy className="h-3 w-3" />
                          </Button>
                        </div>
                          ...
                          <CardContent>
                            <div className="flex items-center gap-2">
                              ...
                              <Button
                                ...
                                className="h-6 w-6 p-0"
                                onClick={() =>
                                  copyToClipboard(parameters.treasury_address)}
                              >
                                <Copy className="h-3 w-3" />
                              </Button>
                            </div>
                            ...
                            <div>
                              ...
                              <div className="flex items-center gap-2 mt-1">
                                ...
                                <Button
                                  ...
                                  className="h-6 w-6 p-0"
                                  onClick={() =>
                                    copyToClipboard(issuer.address)}
                                >
                                  <Copy className="h-3 w-3" />
                                </Button>
                              </div>
                            ...
                            <div>
                              ...
                              <div className="flex items-center gap-2 mt-1">
                                ...
                                <Button
                                  ...
                                  className="h-6 w-6 p-0"
                                  onClick={() =>
                                    copyToClipboard(issuer.public_key)}
                                >
                                  <Copy className="h-3 w-3" />
                                </Button>
                              </div>
