...
export const LOTTIE_ANIMATIONS = {
  ...
  walletMain:
    "https://lottie.host/0e9dd65f-f18d-489b-88c1-eeb2218b735d/DAzEJFWnNZ.json", // Elegant wallet icon
  walletCreate:
    "https://lottie.host/ec1278be-1aa1-45dc-a9f9-65ca8fca6f1e/MjZ123tAmp.json", // Magic sparkles creation
  walletImport:
    "https://lottie.host/a49b2869-cc56-4425-9a19-6cde2b1b7919/di1je0kuBl.json", // FIXED: Using walletCreate (403 error on original)

  // WalletCreator animations - Generation & Import theme
  creating:
    "https://lottie.host/959817d2-7099-402d-8913-67015b4bc9b3/uvwVTUUtnB.json", // FIXED: Using connecting animation (403 error on original)
  importing:
    "https://lottie.host/8d829337-70a0-40c1-9ae9-e55085d7e279/9JGJmBjMGu.json", // FIXED: Using connecting animation (403 error on original)

  // WalletConfirmation animation - Success & Verification theme (green accent)
  success:
    "https://lottie.host/b6668d2f-fc0a-4678-9f3d-378193301306/XJ0mKGjN0b.json", // Success checkmark circle

  // NetworkSetup animation - Network & Globe theme (blue/tech)
  network:
    "https://lottie.host/a9dd7309-d9a5-4a49-bd0f-611682003e92/EifgNUZKhC.json", // Globe with network nodes
  ...
  connected:
    "https://lottie.host/8d829337-70a0-40c1-9ae9-e55085d7e279/9JGJmBjMGu.json", // FIXED: Using success animation (403 error on original)
