      ...
      <Card className="backdrop-blur-md bg-card/80 border border-border">
        ...
        <CardContent className="px-3 sm:px-4 md:px-6 pb-3 sm:pb-4 md:pb-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-2 sm:gap-3 md:gap-4">
            {/* Create New Wallet */}
            <div
              className="group cursor-pointer bg-card rounded border-2 border-border overflow-hidden hover:border-primary/50 hover:bg-primary/5 transition-all duration-300 active:scale-[0.98]"
            ...
            <div
              className="group cursor-pointer bg-card rounded border-2 border-border overflow-hidden hover:border-secondary-foreground/50 hover:bg-secondary/20 transition-all duration-300 active:scale-[0.98]"
          ...
          {/* Security Notice */}
          <div className="mt-3 sm:mt-4 md:mt-6 p-2.5 sm:p-3 md:p-4 bg-accent/10 border border-accent-foreground/30 rounded-lg">
