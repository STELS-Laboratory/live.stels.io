...
import { ArrowUpDown, Filter, TrendingDown, TrendingUp } from "lucide-react";
        ...
        <CardHeader>
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground">
              Comprehensive real-time market information aggregated from global
              exchanges.
            </p>
          </div>
        </CardHeader>
    ...
    <Card className="h-full flex flex-col">
      <CardHeader>
        <div className="space-y-3">
          ...
          <p className="text-sm text-muted-foreground">
            Live trading data with prices, volumes, and spreads. All information
            is continuously collected and processed in real-time from public
            exchange sources worldwide.
          </p>
        </div>
      </CardHeader>
        ...
        <ScrollArea className="h-full">
          <div className="p-4">
            ...
            <div className="grid grid-cols-12 gap-2 px-3 py-2.5 text-[10px] font-semibold text-muted-foreground uppercase tracking-wider border-b border-border bg-muted/20 sticky top-0">
              ...
              >
                Market
                {sortBy === "market" && <ArrowUpDown className="h-3 w-3" />}
              </button>
              <button
              ...
              >
                24h Change
                {sortBy === "change" && <ArrowUpDown className="h-3 w-3" />}
              </button>
...
function MarketTableRow({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "col-span-1 font-mono font-semibold flex items-center gap-1",
          changeColor,
        )}
      >
        {isPositive
