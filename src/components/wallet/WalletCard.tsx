...
export function WalletCard({wallet, onExport, onLock}: WalletCardProps) {
	...
	return (
		<div className="relative group">
			{/* Main Card */}
			<Card
				className="relative overflow-hidden bg-gradient-to-br from-zinc-900 via-zinc-800 to-zinc-900 border-zinc-700/50 shadow-2xl transition-all duration-500 hover:scale-[1.02] hover:shadow-amber-500/20">
				{/* Gradient Overlay */}
				<div
					className="absolute inset-0 bg-gradient-to-br from-amber-500/10 via-transparent to-amber-500/5 opacity-60"/>
				
				{/* Animated Background Pattern */}
				<div className="absolute inset-0 opacity-20">
					<div
						className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(circle_at_50%_50%,rgba(245,158,11,0.1),transparent_50%)] animate-pulse"/>
				</div>
				...
				<CardContent className="relative z-10 space-y-6">
					...
					<div className="space-y-2">
						...
						<div
							className="font-mono text-xl text-zinc-100 tracking-wider bg-zinc-800/50 rounded-lg p-3 border border-zinc-700/50">
				...
				{/* Decorative Elements */}
				<div
					className="absolute top-4 right-4 w-16 h-16 bg-gradient-to-br from-amber-500/20 to-transparent rounded-full blur-xl"/>
				<div
					className="absolute bottom-4 left-4 w-12 h-12 bg-gradient-to-br from-amber-400/20 to-transparent rounded-full blur-lg"/>
			</Card>
		</div>
	);
}
