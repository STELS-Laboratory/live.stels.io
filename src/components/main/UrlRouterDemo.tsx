...
import { navigateTo, getCurrentRouteFromUrl } from '@/lib/router';
	...
	return (
		<Card className="mt-4 w-full max-w-2xl mx-auto">
			<CardHeader>
				...
				<CardDescription>
					Test URL-based routing by clicking buttons or manually changing the URL query parameter
				</CardDescription>
			</CardHeader>
			<CardContent className="space-y-4">
				<div className="grid grid-cols-2 gap-4">
					<div>
						<h4 className="font-medium text-sm text-muted-foreground mb-2">Current State</h4>
						<div className="space-y-2 text-sm">
							<div>
								<span className="text-muted-foreground">Store Route:</span>
								<Badge variant="secondary" className="ml-2">{currentRoute}</Badge>
							</div>
							<div>
								<span className="text-muted-foreground">URL Route:</span>
								<Badge variant="secondary" className="ml-2">{urlRoute || 'none'}</Badge>
							</div>
							<div>
					...
					<div>
						<h4 className="font-medium text-sm text-muted-foreground mb-2">Quick Navigation</h4>
				...
				<div className="border-t pt-4">
					<h4 className="font-medium text-sm text-muted-foreground mb-2">Test URLs</h4>
				...
				<div className="border-t pt-4">
					<h4 className="font-medium text-sm text-muted-foreground mb-2">Invalid Route Test</h4>
