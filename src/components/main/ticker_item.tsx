...
export const TickerItem = React.memo(function TickerItem({
  ...
  const coinIcon = React.useMemo(() => importCoinIcon(baseCurrency), [
    baseCurrency,
  ]);
  const coinFirstLetter = React.useMemo(() => getFirstLetter(baseCurrency), [
    baseCurrency,
  ]);
  const exchangeIcon = React.useMemo(
    () => importExchangeIcon(ticker.exchange),
    [ticker.exchange],
  );
  const exchangeFirstLetter = React.useMemo(
    () => getFirstLetter(ticker.exchange),
    [ticker.exchange],
  );
