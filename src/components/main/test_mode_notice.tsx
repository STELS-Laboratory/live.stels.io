      ...
      <DialogContent className="max-w-md" showCloseButton={false}>
        <DialogHeader>
          ...
          <DialogDescription className="text-left pt-2">
            Important information about the project status and policies.
          </DialogDescription>
        </DialogHeader>
        <div className="text-left space-y-3 pt-2">
          <div className="space-y-2">
            <p className="text-sm text-foreground">
              ...
              This project is developed and owned by Gliesereum Ukraine, with
              rights to all assets and management by Gliese (United States of
              America).
            </p>

            <p className="text-sm text-foreground">
              <strong>Token Policy:</strong>{" "}
              The STELS team does not sell and has never sold any tokens.
            </p>

            <p className="text-sm text-foreground">
              <strong>Project Status:</strong>{" "}
              This project is currently running in test mode.
            </p>

            <p className="text-sm text-foreground">
              <strong>Mainnet Transition:</strong>{" "}
              The transition to mainnet will begin on November 27, 2025.
            </p>

            <p className="text-sm text-foreground">
              <strong>Token Issuance:</strong>{" "}
              Tokens are issued exclusively to developers for building
