...
export function AccountSelector(): React.ReactElement {
  const { selectedAccount, accounts, setSelectedAccount, isViewOnly } =
    useTradingStore();
        ...
        <TooltipTrigger asChild>
          <div className="flex items-center gap-2">
            ...
            >
              ...
              >
                <SelectValue
                  placeholder={isViewOnly && accounts.length === 0
                    ? "View-Only Mode"
                    : "Select account"}
                />
              </SelectTrigger>
                    ...
                    <div className="px-2 py-4">
                      <div className="flex flex-col items-center gap-2 text-center">
                        ...
                        <div className="text-xs text-muted-foreground max-w-[180px]">
                          No trading accounts available. You can view market
                          data, but cannot create orders.
                        </div>
          ...
          <TooltipContent side="bottom" className="max-w-[250px]">
            <div className="text-xs space-y-1">
              ...
              <div className="text-muted-foreground">
                You can view market data, charts, and order book without an
                account. To create orders, add a trading account in the Wallet
                app.
              </div>
            </div>
          </TooltipContent>
