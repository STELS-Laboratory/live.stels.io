        ...
        <div className="flex-1 flex items-center justify-center px-4 py-8">
          <div className="text-center max-w-md space-y-3">
            ...
            <div className="text-xs text-muted-foreground space-y-1">
              <p>
                You can view market data, order book, and trades without an
                account.
              </p>
              <p>
                To create orders, please add a trading account in the Wallet
                app.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-2 p-3 rounded bg-amber-500/10 border border-amber-500/30">
            ...
            <div className="flex flex-col gap-1">
              ...
              <span className="text-xs text-amber-500/90">
                {selectedSymbol}{" "}
                is not in your trading protocol. You can view market data but
                cannot create orders for this pair.
              </span>
            </div>
          </div>
        )}
