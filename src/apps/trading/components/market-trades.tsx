...
import { formatAmount, formatPrice } from "../lib/formatting";

/**
 * Market Trades Component
 */
export const MarketTrades = React.memo(
  function MarketTrades(): React.ReactElement {
    const { selectedSymbol, selectedAccount, selectedExchange } =
      useTradingStore();
