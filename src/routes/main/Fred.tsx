...
import {Activity, BarChart3, Globe, LineChart, PieChart, Search, TrendingUp,} from "lucide-react";
	...
	return (
		<div className="container mx-auto p-6 space-y-8">
			...
			<div className="flex flex-col gap-6">
				<div className="text-center">
					<h1
						className="text-4xl font-black mb-3 bg-gradient-to-r from-amber-500 to-orange-600 bg-clip-text text-transparent">
						World Bank Group
					</h1>
