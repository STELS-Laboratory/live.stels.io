...
import { ExternalLink, Activity, Database, Zap } from 'lucide-react'
						...
						<div className="flex-1 space-y-3">
							...
							<div>
								...
								<p className="text-zinc-300 leading-relaxed">
									Access the new Canvas application for real-time raw data monitoring from the STELS network.
									Get unprocessed, direct insights and analytics as they happen.
								</p>
							</div>
							...
							{/* Action Button */}
							<div className="pt-2">
								<Button asChild className="bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-zinc-950 font-semibold shadow-lg hover:shadow-xl transition-all duration-200">
									<a href="https://canvas.stels.io/" target="_blank" rel="noopener noreferrer">
