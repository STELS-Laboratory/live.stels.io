 ...
 * Application metadata extracted from Welcome.tsx for reuse
 *
 * Note: Original Welcome.tsx contains the main implementation
 * This file provides const exports for potential future use
 */
 ...
 * Matches the applications array from Welcome.tsx
 */
export const SONAR_APPLICATIONS: AppMetadata[] = [
  {
    id: "scanner",
    route: "scanner",
 ...
 */
export const FEATURED_APPS = SONAR_APPLICATIONS.filter((app) => app.featured);
