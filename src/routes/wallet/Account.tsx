									...
									{isNewWallet && (
										<>
											<Alert variant="destructive">
												...
												<AlertDescription>
													Save your private key in a secure, offline location.
			...
			{step === 2 && (
				<Card>
					<CardHeader>
						...
						<CardDescription>
							Fill in the primary details for the exchange account.
						</CardDescription>
					</CardHeader>
			...
			{step === 3 && (
				<Card>
					<CardHeader>
						...
						<CardDescription>
							Set the trading strategy parameters for this account.
						</CardDescription>
					</CardHeader>
					<CardContent>
						<div className="pb-6">
			...
			{step === 4 && finalResult && (
				<Card>
					<CardHeader>
						...
						<CardDescription>
							The signed payload has been generated successfully.
						</CardDescription>
					</CardHeader>
					<CardContent>
			...
			<Dialog open={isConfirmModalOpen} onOpenChange={setIsConfirmModalOpen}>
				<DialogContent className="max-w-3xl">
					<DialogHeader>
						...
						<DialogDescription>
							Review the final JSON payload below. If correct, confirm to apply
							your cryptographic signature. This action cannot be undone.
						</DialogDescription>
					</DialogHeader>
